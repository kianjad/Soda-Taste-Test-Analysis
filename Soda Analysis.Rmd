...
```{r}
interaction.plot(
  x.factor = soda_data$Pouring_Method,
  trace.factor = soda_data$Consumption_Method,
  response = soda_data$Taste_Rating,
  fun = mean,
  type = "b",       # lines and points
  col = c("blue", "red"),
  pch = c(19, 17),  # circle and triangle points
  fixed = TRUE,     # ensure order doesn't shift
  legend = TRUE,
  xlab = "Pouring Method",
  ylab = "Mean Taste Rating",
  trace.label = "Consumption",
  main = "Interaction Plot: Pouring vs Consumption"
)
```
